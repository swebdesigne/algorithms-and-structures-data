...
class ArrayInOb {
    ...
    /*
    * Метод compareTo() класса String используется для выполнения сравнений
    * он возвращает разные целочисленные значения в зависисмости от относительно лексикографического
    * (т. е. алфавитного) расположения объекта String.
    * */
